...
myApp.factory('mySharedService', function($rootScope, CellbaseService){
    ...
    sharedService.regionsAndChromosomesGenes = "20:32850000-33500000,2:12850000-13120000";
...
//        $rootScope.$broadcast('genesRegionToGV');
    ...
    sharedService.broadcastGenesNewResult = function(chromSelected, regions,genesIdFilter,biotypesFilters,fromGV){
        ...
        if (this.genesIdFilter == "" && this.biotypesFilter.length == 0 && this.chromSelected.length == 0 && this.regions == "") {
            ...
            $rootScope.$broadcast('genesNewResult',fromGV);
        }
    };
    ...
    sharedService.broadcastGenesRegionGV = function(region){
        ...
        if(this.genesSpecie.shortName == "hsapiens" || this.genesSpecie.shortName == "mmusculus"){
    ...
    sharedService.broadcastVariantsNewResult = function(chromSelected, regions,snpIdFilter,conseqTypesFilter, fromGV){
        this.chromSelected = chromSelected;
        this.regions = regions;
    ...
    sharedService.broadcastVariationsClear = function(){
        $rootScope.$broadcast('variationsClear');
    };
...
//        }
    ...
    sharedService.broadcastRegulationsClear = function(){
        $rootScope.$broadcast('regulationsClear');
    };
